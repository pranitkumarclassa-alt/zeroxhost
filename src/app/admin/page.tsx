...
import { checkSession, logoutAction, getProducts, addProduct, updateProduct, deleteProduct, getPartners, addPartner, updatePartner, deletePartner } from '../actions';
        ...
        {activeTab === 'products' ? (
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
              {[
                { label: 'Total Assets', value: products.length, icon: Package },
