...
import { serviceLevelAgreement } from '@/lib/siteContent';
    ...
    <main className="relative min-h-screen selection:bg-blue-500/30">
      ...
      <div className="relative z-10">
        <PageHeader
          ...
          subtitle="ZeroXHost service expectations, availability, and support commitments."
          gradient="from-cyan-400 to-blue-600"
        />

        <section className="py-24 px-6">
          <div className="max-w-6xl mx-auto space-y-6">
            {serviceLevelAgreement.map((item, index) => (
              <motion.div
                key={item.title}
