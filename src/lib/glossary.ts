...
export const glossaryItems: GlossaryItem[] = [
  {
    ...
    slug: 'what-is-vps',
    category: 'Hosting',
    searchTerms: ['VPS', 'Virtual Private Server']
  },
  {
    ...
    searchTerms: ['KVM', 'Kernel-based Virtual Machine']
  },
  {
    ...
    slug: 'what-is-ddos',
    category: 'Security',
    searchTerms: ['DDoS', 'Distributed Denial of Service']
  },
  {
    ...
    slug: 'what-is-nvme',
    category: 'Storage',
    searchTerms: ['NVMe', 'Non-Volatile Memory express']
  },
  {
    ...
    slug: 'what-is-sla',
    category: 'Business',
    searchTerms: ['SLA', 'Service Level Agreement']
  }
];
